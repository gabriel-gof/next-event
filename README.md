...
- **Compact Bar Widget**: Always renders one camera glyph instead of an event title or countdown. Gray means no timed events remain today, blue means at least one remains later today, yellow means the next event is within 30 minutes, orange means within 10 minutes, and pink means an event is happening now
